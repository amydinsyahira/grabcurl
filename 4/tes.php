...
$url='www.tiket2.com/english/search/flights.html';
if ($_REQUEST['search_flights[trip]'] == 'one+way') {
	$d['search_flights[trip]'] = $_REQUEST['search_flights[trip]'];
	$d['search_flights[passengers]'] = $_REQUEST['search_flights[passengers]'];
	$d['search_flights[flight_from_airport]'] = $_REQUEST['search_flights[flight_from_airport]'];
	$d['search_flights[flight_to_airport]'] = $_REQUEST['search_flights[flight_to_airport]'];
	$d['search_flights[date_from_day]'] = $_REQUEST['search_flights[date_from_day]'];
	$d['search_flights[date_from_month_year]'] = $_REQUEST['search_flights[date_from_month_year]'];
	$d['search_flights[_csrf_token]'] = $_REQUEST['search_flights[_csrf_token]'];
} else {
	$d['search_flights[trip]'] = $_REQUEST['search_flights[trip]'];
	$d['search_flights[passengers]'] = $_REQUEST['search_flights[passengers]'];
	$d['search_flights[flight_from_airport]'] = $_REQUEST['search_flights[flight_from_airport]'];
	...
	$d['search_flights[date_from_day]'] = $_REQUEST['search_flights[date_from_day]'];
	$d['search_flights[date_from_month_year]'] = $_REQUEST['search_flights[date_from_month_year]'];
	$d['search_flights[date_to_day]'] = $_REQUEST['search_flights[date_to_day]'];
	$d['search_flights[date_to_month_year]'] = $_REQUEST['search_flights[date_to_month_year]'];
	$d['search_flights[_csrf_token]'] = $_REQUEST['search_flights[_csrf_token]'];
}
